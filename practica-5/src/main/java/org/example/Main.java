...
import org.example.controladores.ChatControlador;
...
public class Main {
    public static void main(String[] args) {
        ...
        app.get("/", ctx -> {
            ...
            if(ctx.queryParam("paginaActual") != null || ctx.queryParam("etiqueta") != null){
                ctx.render("/vistas/pagination.html", model);
            }else {
