...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        app.post("https://www.google.com/search", ctx -> {
            // Obtener el cuerpo de la solicitud
            String requestBody = ctx.body();

            // Obtener el encabezado "matricula-id"
            String matriculaId = ctx.header("1014-7069");

            // Mostrar el cuerpo y la matrícula recibidos
            System.out.println("Cuerpo de la solicitud: " + requestBody);
            System.out.println("Matrícula ID recibida: " + matriculaId);

            ctx.status(200).result("Solicitud POST recibida"); // Responder con un mensaje
        });
